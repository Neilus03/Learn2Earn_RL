...
wandb.init(project="breakout-a2c-test", entity= "ai42", sync_tensorboard=True)
...
unzip_file('a2c_Breakout_1M.zip', 'a2c_Breakout_1M_unzipped') 
...
model.policy.load_state_dict(torch.load("/home/ndelafuente/Learn2Earn_RL/BreakOut/BreakOut_sb3_A2C/a2c_Breakout_1M_unzipped/policy.pth"))
model.policy.optimizer.load_state_dict(torch.load("/home/ndelafuente/Learn2Earn_RL/BreakOut/BreakOut_sb3_A2C/a2c_Breakout_1M_unzipped/policy.optimizer.pth"))
